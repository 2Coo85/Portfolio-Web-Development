    ...
    <div class="flex-container secondary">
        <main class="proj-page-body">
            ...
            <section class="project-box box-1 popup" id="IntHTML">
                ...
                <p>Skills: HTML, CSS</p>
                <section>
                    <a href="http://webtrain.austincc.edu/~thenderson/IntHTML/Final_Project/index.html">Facets of Me</a>
                </section>
            </section>
            <section class="project-box box-2 popup" id="AdvHTML">
                <section class="x">
                    <a href="#">X</a>
                </section>
                <img src="img/Adv-HTML.jpg" width="100" height="125" alt="snapshot of main page">
                ...
                <a href="http://webtrain.austincc.edu/~thenderson/AdvHTML/AdvProj/index.html">Inside the Rock</a>
                   
            </section>
            <section class="project-box box-3 popup" id="interactive">
                <section class="x">
                    <a href="#">X</a>
                </section>
                <img src="img/interactive.jpg" width="100" height="125" alt="snapshot of main page">
                ...
                <a href="http://webtrain.austincc.edu/~thenderson/InteractiveDesign/index.html">Interactive Design</a>
            </section>
            <section class="project-box box-4 popup" id="php">
                <section class="x">
                    <a href="#">X</a>
                </section>
                <img src="img/PHP.jpg" width="100" height="125" alt="snapshot of main page">
                ...
                <a href="http://webtrain.austincc.edu/~thenderson/PHP/textProj.php">Favorite Things</a>
            </section>
            <section class="project-box box-5 popup" id="capstone">
                <section class="x">
                    <a href="#">X</a>
                </section>
                <img src="img/Capstone.jpg" width="100" height="125" alt="snapshot of main page">
                ...
                <a href="http://webtrain.austincc.edu/~thenderson/Capstone/Final/index.html">Talk</a>
            </section>
            <section class="project-box box-6 popup" id="teddybears">
                <section class="x">
                    <a href="#">X</a>
                </section>
                <img src="img/Orinoco.png" width="100" height="125" alt="snapshot of main page">
                ...
                <p>Skills: HTML, CSS, JavaScript, SCSS</p>
                <p><emphasis>Note</emphasis>: must run a node server to run application</p>
                <a href="2coo85.github.io/TeddyBears/">Orinoco Handmade Teddy Bears</a>
            </section>
            <section class="project-box box-7 popup" id="sopekocko">
                <section class="x">
                    <a href="#">X</a>
                </section>
                <img src="img/SoPekocko.png" width="100" height="125" alt="snapshot of main page">
